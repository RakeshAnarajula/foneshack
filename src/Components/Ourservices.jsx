...
// const Card = ({ image, title, description, icon: IconComponent, path }) => {
...
// const App = () => {
//   return (
//     <div className="min-h-screen flex flex-col items-center p-8 bg-gradient-to-r from-gray-900 to-gray-800">
//       {/* Title Section */}
