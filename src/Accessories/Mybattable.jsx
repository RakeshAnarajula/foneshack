    ...
    <div className="min-h-screen bg-gradient-to-t from-gray-700 to-gray-900 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold text-white drop-shadow-lg">
          MyBat Pro <span className="text-red-600 ">Accessories</span> Showcase
        </h1>
      ...
      >
        <div className="flex flex-col lg:flex-row">
                  ...
                  {selectedTitle.additionalItems && (
                    <div className="mt-4 overflow-y-auto max-h-64">
                      <h3 className="text-lg font-semibold mb-2 text-gray-800">
                        Available {selectedTitle.title} Models:
                      </h3>
          ...
          <div className="lg:w-1/4 p-4 bg-gray-100 flex justify-center items-center">
            {selectedTitle && (
              <motion.img
                ...
                className="w-full max-w-[250px] lg:max-w-[300px] h-auto object-cover rounded-md"
              />
            )}
          </div>
        </div>
