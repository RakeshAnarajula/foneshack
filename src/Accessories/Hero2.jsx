...
const Hero2 = ({ scrollToAccessories }) => {
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden bg-gray-900">
      <div
        ...
        style={{ backgroundImage: 'url("/accessoriesmobilemenu.jpg")' }}
      ></div>
      <div
      ...
      <div className="relative z-10 text-center text-white p-6 md:p-12">
        ...
        >
       Explore the latest in mobile accessories: power-packed, stylish, and built to last!
        </motion.p>
        <motion.button
...
Hero2.propTypes = {
  scrollToAccessories: PropTypes.func.isRequired,
};
